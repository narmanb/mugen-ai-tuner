...
import com.narmanb.mugenaituner.core.AiStrengthEstimator
import com.narmanb.mugenaituner.core.AnalyzerCompatibilityEstimator
...
@Composable
internal fun MugenAiTunerScreen() {
    ...
    LazyColumn(
        ...
        item {
            ...
            Text(
                "Offline AI analysis and safe difficulty tuning for MUGEN and IKEMEN characters. 50% is the standardized Normal target; the analyzer traces actual AI logic instead of assuming var(59) means AI.",
...
private fun DifficultyControls(
    ...
    Card(modifier = Modifier.fillMaxWidth()) {
        Column(
            ...
            Text(
                "50% is the app's standardized Normal target. Presets move understood AI toward shared behavior targets; Custom lets you tune detected categories individually.",
                style = MaterialTheme.typography.bodySmall,
            )
            ...
            Row(
                ...
                Column(modifier = Modifier.weight(1f)) {
                    ...
                    Text(
                        "AILevel 4 uses your selected standardized target. Levels 1–3 are weaker; levels 5–8 rise toward the app's Expert/100% target.",
                        style = MaterialTheme.typography.bodySmall,
                    )
                }
                Switch(
